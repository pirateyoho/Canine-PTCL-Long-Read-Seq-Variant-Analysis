...
pbmm2 align --num-threads 24 CanFam31.mmi ${file} ../output/${name}.CanFam3.aligned.bam --preset HIFI --sample ${name}
pbmm2 align --num-threads 24 CanFam4.mmi ${file} ../output/${name}.CanFam4.aligned.bam --preset HIFI --sample ${name}
done
